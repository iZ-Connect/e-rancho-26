  ...
  return (
    <div className="max-w-3xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="text-center space-y-4">
        ...
        <h2 className="text-4xl font-black text-white tracking-tight">Sobre o e-Rancho</h2>
        <p className="text-slate-400 font-medium">Versão 1.2.0 • Gestão Inteligente de Arranchamento</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="glass p-8 rounded-3xl border border-white/10 space-y-4">
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            O e-Rancho foi desenvolvido para modernizar o controle de alimentação nas unidades militares,
      ...
      <div className="text-center">
        <p className="text-[10px] text-slate-600 font-bold tracking-[0.4em]">© 2025 e-Rancho • Todos os direitos reservados</p>
      </div>
    </div>
  );
};
